...
API.add 'scripts/2noddy/oab',
  get:
    ...
    action: () ->
      ...
      # oab_history should be snapshotted and backed up, then totally wiped
      # same with oab_availability - just add a note to stats page of how many we had before our update (7243384) (1114919 without gsot.gbv.de) (from 27/10/2016 to 05/03/2018)
      ...
      # snapshot and delete ones where a record may be useful
      # oab, oabutton (if don't still have a snapshot of this old one)

      # delete unnecessary indexes
      # leaps, dev, devbebejam, devclapi, devleviathan, devoab, leviathan
