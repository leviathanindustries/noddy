...
# als managed to time out on text extracted from a 5 page pdf so increased timeout to 60000
...
API.use.corenlp.run = (q, options, cache=false, url='http://10.131.80.136:9000') ->
