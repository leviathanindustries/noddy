...
oab_dnr = new API.collection("oab_dnr");
oab_support = new API.collection("oab_support");
oab_meta = new API.collection("oab_meta");
oab_availability = new API.collection("oab_availability");
oab_request = new API.collection({type:"oab_request",history:true}); // TODO requires completion of request history logging, like oab dev does
oab_ill = new API.collection("oab_ill");


API.addRoute('service/oab', {
  get: {
    action: function() {
  ...
  post: {
    action: function() {
      ...
      if ( this.request.headers['x-apikey'] ) {
        // we don't require auth for availability checking, but we do want to record the user if they did have auth
        var acc = API.accounts.retrieve(this.request.headers['x-apikey']);
        if (acc) {
          opts.uid = acc._id;
          opts.username = acc.username;
          opts.email = acc.emails[0].address;
...
API.addRoute('service/oab/availability', _avail);
API.addRoute('service/oab/find', _avail);

API.addRoute('service/oab/ill/:library', {
  post: {
    action: function() {
      ...
      return {status:'success',data:API.service.oab.ill(opts)};
    }
  }
});

API.addRoute('service/oab/request', {
  get: {
    roleRequired:'openaccessbutton.user',
    action: function() {
  ...
  post: {
    action: function() {
      ...
      return API.service.oab.request(req,uid,this.queryParams.fast);
    }
  }
});
API.addRoute('service/oab/request/:rid', {
  get: {
    action: function() {
      ...
      if (r) {
        ...
        if (uid) r.supports = API.service.oab.supports(this.urlParams.rid,uid);
  ...
  post: {
    ...
    action: function() {
      var r = oab_request.findOne(this.urlParams.rid);
      if (r) {
        if (r.user === undefined && !r.story && this.request.body.story ) r = API.service.oab.own(r._id,this.userId);
        ...
        if (this.request.body.email !== undefined && ( API.accounts.auth('openaccessbutton.admin',this.user) || r.status === undefined || r.status === 'help' || r.status === 'moderate' || r.status === 'refused' ) ) n.email = this.request.body.email;
  ...
  delete: {
    ...
    action: function() {
      var r = oab_request.findOne(this.urlParams.rid);
      if ( API.accounts.auth('openaccessbutton.admin',this.user) || this.userId === r.user.id ) oab_request.remove(this.urlParams.rid);
...
API.addRoute('service/oab/request/:rid/admin/:action', {
  get: {
...
API.addRoute('service/oab/own/:rid', {
  post: {
    roleRequired:'openaccessbutton.user',
    action: function() {
      return API.service.oab.own(this.urlParams.rid,this.userId,this.queryParams.anonymous);
    }
  }
});

API.addRoute('service/oab/support/:rid', {
  get: {
    action: function() {
      return API.service.oab.support(this.urlParams.rid,this.queryParams.story,this.userId);
    }
  },
  post: {
    action: function() {
      ...
      return API.service.oab.support(this.urlParams.rid,this.request.body.story,uid);
    }
  }
});

API.addRoute('service/oab/supports/:rid', {
  get: {
    roleRequired:'openaccessbutton.user',
    action: function() {
      return API.service.oab.supports(this.urlParams.rid,this.userId);
    }
  }
});

API.addRoute('service/oab/supports', {
  get: {
    action: function() {
      return oab_support.search(undefined,this.queryParams)
    }
  },
  post: {
    action: function() {
      return oab_support.search(this.bodyParams,this.queryParams)
    }
  }
});

API.addRoute('service/oab/availabilities', {
  get: {
    action: function() {
      return oab_availability.search(undefined,this.queryParams)
    }
  },
  post: {
    action: function() {
      return oab_availability.search(this.bodyParams,this.queryParams)
    }
  }
});

API.addRoute('service/oab/requests', {
  get: {
    action: function() {
      return oab_request.search(undefined,this.queryParams)
    }
  },
  post: {
    action: function() {
      return oab_request.search(this.bodyParams,this.queryParams)
    }
  }
});
...
API.addRoute('service/oab/users', {
  get: {
    roleRequired:'openaccessbutton.admin',
    action: function() {
      return Users.search(undefined,this.queryParams) // TODO should just be OAB users
    }
  },
  post: {
    roleRequired:'openaccessbutton.admin',
...
API.addRoute('service/oab/scrape', {
  get: {
    //roleRequired:'openaccessbutton.user',
    action: function() {
      return {status:'success',data:API.service.oab.scrape(this.queryParams.url,this.queryParams.content,this.queryParams.refresh,this.queryParams.doi)};
    }
  }
});

API.addRoute('service/oab/accepts', {
  get: {
    action: function() {
      return {status:'success',data:API.service.oab.accepts()};
    }
  },
  post: {
    roleRequired:'openaccessbutton.admin',
    action: function() {
      return {status:'success',data:API.service.oab.accepts(this.request.body)};
    }
  }
});

API.addRoute('service/oab/blacklist', {
  get: {
    action: function() {
      return {status:'success',data:API.service.oab.blacklist(undefined,undefined,this.queryParams.stale)};
    }
  }
});

API.addRoute('service/oab/templates', {
  get: {
    action: function() {
      return {status:'success',data:API.service.oab.template(this.queryParams.template,this.queryParams.refresh)};
    }
  }
});

API.addRoute('service/oab/substitute', {
  post: {
    action: function() {
      return {status:'success',data:API.service.oab.substitute(this.request.body.content,this.request.body.vars,this.request.body.markdown)};
    }
  }
});

API.addRoute('service/oab/sendmail', {
  post: {
    roleRequired:'openaccessbutton.admin',
    action: function() {
      return {status:'success',data:API.service.oab.sendmail(this.request.body)};
    }
  }
});

API.addRoute('service/oab/receive/:rid', {
  get: {
    action: function() {
    ...
    action: function() {
      ...
      if (r) {
        ...
        if (this.bodyParams.admin && ( this.request.headers['x-apikey'] || this.queryParams.apikey ) ) {
          var apikey = this.queryParams.apikey ? this.queryParams.apikey : this.request.headers['x-apikey'];
          var acc = API.accounts.retrieve(apikey);
          if (acc && API.accounts.auth('openaccessbutton.admin',acc)) admin = true;
        }
        return API.service.oab.receive(this.urlParams.rid,this.bodyParams.content,this.bodyParams.url,this.bodyParams.title,this.bodyParams.description,this.bodyParams.firstname,this.bodyParams.lastname,undefined,admin);
      } else {
        return {statusCode: 404, body: {status: 'error', data:'404 not found'}}        
      }
    }
...
API.addRoute('service/oab/redeposit/:rid', {
  post: {
    roleRequired: 'openaccessbutton.admin',
    action: function() {
      return API.service.oab.redeposit(this.urlParams.rid);
    }
  }
});
API.addRoute('service/oab/receive/:rid/:holdrefuse', {
  get: {
    action: function() {
      var r = oab_request.findOne({receiver:this.urlParams.rid});
      if (r) {
...
API.addRoute('service/oab/dnr', {
  get: {
    action: function() {
      ...
      if (!d.dnr && this.queryParams.user) {
        var u = API.accounts.retrieve(this.queryParams.user);
      ...
      if (!d.dnr && this.queryParams.validate) {
        ...
        d.validation = API.mail.validate(this.queryParams.email);
  ...
  post: {
    action: function() {
      ...
      if (e) {
        return {status:'success',data:API.service.oab.dnr(e,true,refuse)};
      } else {
...
API.addRoute('service/oab/job', {
  post: {
    ...
    action: function() {
      ...
      // var jid = API.job.create({user:this.userId,service:'openaccessbutton',method:API.service.oab.availability,name:"oab_availability",list:list});
      return this.request.body;//jid;
    }
  }
});

API.addRoute('service/oab/status', {
  get: {
    action: function() {
      return {status:'success',data:API.service.oab.status()};
    }
  }
});
...
API.service.oab.status = function() {
  return {
    ...
    users: API.accounts.count({"roles.openaccessbutton":{$exists:true}}),
...
*/
API.service.oab.accepts = function(addition) {
...
API.service.oab.dnr = function(email,add,refuse) {
  ...
  if (add && !ondnr) {
    ...
    if (refuse) {
      ...
      for ( var req in rqs ) API.service.oab.refuse(req._id,'Author DNRd their email address');
    } else {
...
API.service.oab.blacklist = function(url,fulltextable,stale) {
  if (stale === false) stale = 0;
  if (stale === undefined) stale = 60000;
  if (url !== undefined && (url.length < 4 || url.indexOf('.') === -1) ) return false;
  var bl = API.use.google.sheets.feed(Meteor.settings.openaccessbutton.blacklist_sheetid,stale);
  var blacklist = [];
  ...
  if (url) {
    ...
    /*if (fulltextable) {
      var ft = API.use.google.sheets.feed(Meteor.settings.openaccessbutton.repositories_sheetid,stale);
      for ( var f in ft ) {
...
*/
API.service.oab.request = function(req,uid,fast) {
  ...
  if (!req.test && API.service.oab.blacklist(req.url)) return false;
  ...
  if (!fast && (!req.title || !req.email) ) { // worth scraping on any other circumstance?
    var meta = API.service.oab.scrape(req.url,dom,undefined,req.doi);
  ...
  req.receiver = API.store.receiver(req); // is store receiver really necessary here?
...
API.service.oab.admin = function(rid,action) {
  var r = oab_request.findOne(rid);
  var vars = API.service.oab.vars(r);
  var usermail;
  if (r.user && r.user.id) {
    var u = API.accounts.retrieve(r.user.id);
  ...
  if (action === 'send_to_author') {
    ...
    if (requestors.length) API.service.oab.sendmail({vars:vars,template:{filename:'requesters_request_inprogress.html'},to:requestors});
    if (r.type === 'article') {
      if (r.story) {
        if (r.email) API.service.oab.sendmail({vars:vars,template:{filename:'author_request_article_v2.html'},to:r.email});
      } else {
        if (r.email) API.service.oab.sendmail({vars:vars,template:{filename:'author_request_article_v2_nostory.html'},to:r.email});
      }
    } else {
      if (r.email) API.service.oab.sendmail({vars:vars,template:{filename:'author_request_data_v2.html'},to:r.email});      
    }
    ...
    if (usermail) API.service.oab.sendmail({vars:vars,template:{filename:'initiator_invalid.html'},to:usermail});
  } else if (action === 'dead_author') {
    update.status = 'closed';
    if (requestors.length) API.service.oab.sendmail({vars:vars,template:{filename:'requesters_request_failed_authordeath.html'},to:requestors});
  } else if (action === 'user_testing') {
    update.test = true;
    update.status = 'closed';
    if (r.story) update.rating = 0;
    if (usermail) API.service.oab.sendmail({vars:vars,template:{filename:'initiator_testing.html'},to:usermail});
  } else if (action === 'broken_link') {
    if (usermail) API.service.oab.sendmail({vars:vars,template:{filename:'initiator_brokenlink.html'},to:usermail});
...
API.service.oab.own = function(rid,uid,anonymous) {
  ...
  if (!req || !user) {
    ...
    if (req.user === undefined && user) {
      if (anonymous && API.accounts.auth('openaccessbutton.admin',user)) {
        req.user = {
          admin: user._id,
          username: 'anonymous'
        }
...
API.service.oab.scrape = function(url,content,refresh,doi) {
  var s = API.academic.catalogue.extract(url,content,refresh,doi);
  var email;
  ...
  if (s.email) {
    for (var e in s.email) {
      ...
      if ( ( email === undefined || isauthor ) && !API.service.oab.dnr(s.email[e]) && API.mail.validate(s.email[e]).is_valid ) email = s.email[e];
    }
  }
  s.email = email;
  return s;
...
API.service.oab.support = function(rid,story,uid) {
  ...
  if (uid === undefined) {
    ...
    return anons;
  } else if ( r.user && r.user.id !== uid && API.service.oab.supports(rid,uid).length === 0 ) {
...
API.service.oab.supports = function(rid,uid,url) {
  var matcher = {};
  if (rid && uid) {
...
API.service.oab.ill = function(opts) {
  if (opts.library === 'imperial') {
    ...
    API.service.oab.sendmail({template:{filename:'imperial_confirmation_example.txt'},to:opts.id});
...
API.service.oab.ill_progress = function() {
...
*/
API.service.oab.availability = function(opts) {
  ...
  if (opts.library) {
    ...
    meta = API.academic.catalogue.extract(opts.url,opts.dom);
    if (meta.title) {
      ret.library.title = meta.title;
      var tqr = 'title,exact,'+meta.title.replace(/ /g,'+');
      var lib = API.use.exlibris.primo(tqr,undefined,undefined,opts.library);
    ...
    if ( meta.journal ) {
      ...
      var jrnls = API.use.exlibris.primo(jqr,undefined,50,opts.library);
  ...
  if ( opts.type === 'article' || opts.type === undefined ) {
    ...
    if (opts.refresh !== true && opts.url) {
      ...
      if (avail && !API.service.oab.blacklist(avail.discovered.article)) {
    ...
    if (url === undefined) {
      var res = API.academic.resolve(opts.url,opts.dom); // opts.url could actually be a pmid, pmc, or doi - this checks oabutton for received requests too
  ...
  for ( var r in requests ) {
    if ( already.indexOf(requests[r].type) === -1 ) {
      ...
      if (opts.uid) {
        var supported = API.service.oab.supports(requests[r]._id,opts.uid);
  ...
  var accepts = API.service.oab.accepts();
...
API.service.oab.find = API.service.oab.availability;

API.service.oab.hold = function(rid,days) {
  ...
  //API.sendmail(); // inform requestee that their request is on hold
  return {status: 'success', data: r};
}

API.service.oab.refuse = function(rid,reason) {
  var today = new Date().getTime();
  var r = oab_request.findOne(rid);
  if (r.holds === undefined) r.holds = [];
  if (r.hold) r.holds.push(r.hold);
  ...
  //API.sendmail(); // inform requestee that their request has been refused
  return {status: 'success', data: r};
}

API.service.oab.followup = function(rid) {
  ...
  if (dnr) {
    ...
    //API.sendmail(); //email the request email contact with the followup request
...
API.service.oab.receive = function(rid,content,url,title,description,firstname,lastname,cron,admin) {
  ...
  if (!r) {
    ...
    if (content) {
      ...
      if (r.type === 'data') {
        ...
        var listing = [];
        try {
          var l = API.tdm.extract({url:"https://osf.io/view/osfm2015/",match:'/\{"nodeurl.*/gi',start:"meetingData",end:"];"});
        ...
        var z = API.use.zenodo.deposition.create({title:title,description:description,creators:creators,doi:r.doi},up,Meteor.settings.openaccessbutton.zenodo_token);
    ...
    //if (tmplfn) API.service.oab.sendmail({template:{filename:tmplfn},bcc:whoto});
...
API.service.oab.redeposit = function(rid) {
  var r = oab_request.findOne({receiver:rid});
  var today = new Date().getTime();
  var rdir = Meteor.settings.uploadServer.uploadDir + 'openaccessbutton/' + rid + '/';
  var files = fs.readdirSync(rdir);
  ...
  if (r.type === 'data') {
    ...
    var up = {file:rdir+fl,name:fl};
    if (Meteor.settings.openaccessbutton.zenodo_deposit_autopublish) up.publish = true;
    var z = API.use.zenodo.deposition.create({title:title,description:description,doi:r.doi},up,Meteor.settings.openaccessbutton.zenodo_token);
    if (z.id) {
...
API.service.oab.validate = function(rid,uid) {
  var r = oab_request.findOne(rid);
  if (r) {
    var today = new Date().getTime();
...
API.service.oab.template = function(template,refresh) {
  ...
  if (refresh || mail_template.find({service:'openaccessbutton'}).count() === 0) {
    ...
    for ( var f in fls ) {
      ...
      var content = HTTP.call('GET',flurl + '/' + fls[f]).content;
      API.mail.template(undefined,{filename:fls[f],service:'openaccessbutton',content:content});
    }
  }
  if (template) {
...
API.service.oab.vars = function(vars) {
  if (vars && vars.user) {
    var u = API.accounts.retrieve(vars.user.id);
    if (u) {
...
API.service.oab.substitute = function(content,vars,markdown) {
...
API.service.oab.sendmail = function(opts) {
  ...
  return API.mail.send(opts,Meteor.settings.openaccessbutton.mail_url);
}

API.service.oab.cron = {}
API.service.oab.cron.osf = function() {
...
API.service.oab.cron.availability = function() {
  ...
  requests.forEach(function(request) {
    ...
    var availability = API.service.oab.availability({url:request.url,type:request.type,nosave:true});
    if (availability.availability.length > 0) {
      for ( var a in availability.availability ) {
        if (availability.availability[a].type === request.type) {
          API.service.oab.receive(
            request.receiver,
            undefined,
...
if ( Meteor.settings.openaccessbutton && Meteor.settings.openaccessbutton.cron ) {
  ...
  if (Meteor.settings.openaccessbutton.cron.availability) {
    SyncedCron.add({
      ...
      job: API.service.oab.cron.availability
    });
  }
}
